...
# 4. Ft vs vb (HARA)
plot(vb_h, Ft_h, pch = 16, col = "red", cex = 0.4,
     xlab = "Vulnerable biomass", ylab = "Fishing mortality Ft",
...
plot(vb_seq, TAC, type = "l", lwd = 2, col = "black",
...
plot(vb_seq, Ft_implied, type = "l", lwd = 2, col = "blue",
...
# 1. F(t)
plot(t_seq, Ft_y_sub, type = "l", lwd = 2, col = "blue",
...
# 2. Biomass
plot(t_seq, vb_y_sub, type = "l", lwd = 2, col = "blue", ylim = c(0, 3),
...
# 3. Yield
plot(t_seq, yield_y_sub, type = "l", lwd = 2, col = "blue",
