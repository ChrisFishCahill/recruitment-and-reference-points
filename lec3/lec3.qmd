...
N_{t,a} =
\begin{cases}
\displaystyle \frac{\alpha \cdot SSB_{t-1}}{1 + \beta \cdot SSB_{t-1}} \cdot e^{w_{t-1}}, & a = 1 \\\\
N_{t-1,a-1} \cdot e^{-Z_{t-1,a-1}}, & 2 \leq a < a_{\text{max}} \\\\
N_{t,a_{\text{max}}} + N_{t-1,a_{\text{max}}} \cdot e^{-Z_{t-1,a_{\text{max}}}}, & a = a_{\text{max}} \text{ (plus group)}
\end{cases}
$$
...
- $w_t \sim \text{Normal}(0, \sigma^2_{r} = 0.6)$ 
...
![](images/yep_wilberg.png){fig-align="center" width="1000" height="500"} 
[Wilberg et al. 2005]{.footerRight}

## The Saga of Lake Michigan Yellow Perch

![](images/Wilberg_mortality.png){fig-align="center" width="950" height="550"} 
[Wilberg et al. 2005]{.footerRight}
